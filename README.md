...
# 🛡️ Integrated Security Blueprint – Qubes OS + Kicksecure
...
This is the **English version** – an Arabic version is also available in the repository.
...
- ⚡ **Automated helper script** that applies most settings with one click (Tab 11)
...
🔗 [**Click here for English version preview**](https://htmlpreview.github.io/?https://github.com/abdullah127-code/qubes-os-security-/blob/main/q_en.html)
...
- ✅ Kernel parameters for dom0 and all VMs (GRUB + Secureblue sysctl)
- ✅ MAC randomization and IPv6 disable
- ✅ Creation of multiple Whonix gateways
- ✅ Kicksecure installation and hardening (user‑space)
...
This work is licensed under the **MIT License** – you may freely use, modify, and share it with attribution to the source.
